...
public class NewProducts extends JFrame {
    ...
    public NewProducts() {
        ...
        comboBox.setModel(new DefaultComboBoxModel(new String[] {" ","水果", "主食", "蔬菜", "文体办公", "家电五金", "洗浴用品","服装"}));
        ...
        btnNewButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if(ProductNo.getText().isEmpty()){
                    ...
                    product.setpNo(ProductNo.getText());
                    ...
                    if(ProductName.getText().isEmpty()){
                        ...
                        if(Unit.getText().isEmpty()){
                            ...
                            if(pCount.getText().isEmpty()){
                                ...
                                product.setPcount(Integer.valueOf(pCount.getText()));
