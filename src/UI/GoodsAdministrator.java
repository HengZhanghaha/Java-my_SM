...
public class GoodsAdministrator extends JFrame {
    ...
    public GoodsAdministrator() {
        ...
        button.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if(!productNo.isEmpty()){
                    ...
                    Object[] row = {productInfo.getpNo(),productInfo.getCategoryName(),productInfo.getpName(),productInfo.getType()
                            ,productInfo.getUnit(),productInfo.getPcount(),productInfo.getPrice(),productInfo.getDiscount()};
                    model.addRow(row);
        ...
        button.setBounds(451, 280, 117, 23);
        ...
        btnNewButton_6.setBounds(451, 306, 117, 23);
